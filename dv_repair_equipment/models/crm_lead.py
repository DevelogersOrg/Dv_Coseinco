...
class CrmLead(models.Model):
    ...
    repair_order_type_id = fields.Selection([('remote', 'Remoto'), ('in_person', 'Presencial'), ('workshop', 'Taller'), (
        'external', 'Externo')], string='Tipo de Servicio a Desarrollar', required=True, default='remote')
