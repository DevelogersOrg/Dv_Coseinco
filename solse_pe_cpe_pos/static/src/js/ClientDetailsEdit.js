odoo.define('solse_pe_cpe_pos.ClientDetailsEdit', function(require) {
    'use strict';
    ...
    const ClientDetailsEditCPE = ClientDetailsEdit =>
        class extends ClientDetailsEdit {
            constructor() {
			    ...
			    this.provincia = null;
			    this.distrito = null;
			    this.intFields = ['country_id', 'state_id', 'city_id', 'l10n_pe_district', 'zip', 'property_product_pricelist'];
    ...
    Registries.Component.extend(ClientDetailsEdit, ClientDetailsEditCPE);
