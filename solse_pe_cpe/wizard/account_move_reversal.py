...
class AccountMoveReversal(models.TransientModel):
	...
	def reverse_moves(self):
		moves = self.move_ids
		for reg in moves:
			tipo = self.pe_credit_note_code
			if tipo == '13' and reg.invoice_payment_term_id.tipo_transaccion != 'credito':
				raise UserError('Este tipo solo es permitido para facturas al crédito')
	...
	# invoice_id.pe_credit_note_code == '13'
