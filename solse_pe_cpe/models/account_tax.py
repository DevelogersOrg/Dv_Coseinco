...
class AccountTax(models.Model):
	...
	mostrar_base = fields.Boolean(related="tax_group_id.mostrar_base", store=True)
	...
	def compute_all_sunat(self, price_unit, currency=None, quantity=1.0, product=None, partner=None, is_refund=False, handle_price_include=True):
